...
signtool sign /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 /a "release_artifacts\DQOPR-NetPulse-Setup-0.1.1.exe"
```
...
signtool verify /pa /all "release_artifacts\DQOPR-NetPulse-Setup-0.1.1.exe"
```
